...
public class Lambda03RPT {
    ...
    public static void printEvens(List<Integer> myList){
        myList.
                stream().
                filter(UtilsRPT::checkToBeEven).
                forEach(UtilsRPT::printWithSpace);
    }
