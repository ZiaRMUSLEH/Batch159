...
public class ArrayListRPT {
    public static void main(String[] args) {
        ...
        if (cities.equals(newCities)){
            System.out.println("Array is in alphabetical order");
        } else {System.out.println("Array is not in alphabetical order");}
        ...
        System.out.println(ex1); //[12, 15, 31, 32, 54]
        ...
        for (int i = 1; i<ex1.size(); i++){
            if (minDif==(ex1.get(i)-ex1.get(i-1))){
                System.out.println(ex1.get(i-1)+" and "+ex1.get(i));
            }
        }
        ...
        for (Integer w: ex4){
            if (ex4.indexOf(w)!=ex4.lastIndexOf(w)){
                ...
                System.out.println("Arraylist elements are not unique"); break;
            } else {counter++;}

            if (counter == ex4.size()){
                System.out.println("ArrayList elements are unique");
            }
        }
    }
}
